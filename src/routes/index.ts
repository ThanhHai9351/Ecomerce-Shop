...
export const routes: Route[] = [
  ...
  //   { path: "/admin/customers", element: (CustomerAdmin), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/staffs", element: (StaffAdmin), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/products", element: (ProductAdmin), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/product/create", element: (CreateProduct), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/orders", element: (OrderAdmin), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/settings", element: (SettingAdmin), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/categories", element: (CategoryAdmin), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/posts", element: (PostAdmin), isShowHeader: false, isAdmin: true },
  //   { path: "/admin/chats", element: (ChatAdmin), isShowHeader: false, isAdmin: true },
  //   //auth
